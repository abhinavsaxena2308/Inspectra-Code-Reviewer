          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-surface border border-white/10 text-on-surface py-2 pl-10 pr-10 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-fuchsia-500/50 cursor-pointer min-w-[200px]"
              >
            ...
            <button
              ...
              className="px-4 py-2 bg-fuchsia-500 text-white rounded-md text-sm font-semibold flex items-center gap-2 hover:bg-fuchsia-600 transition-colors disabled:opacity-50 shadow-lg shadow-fuchsia-500/20"
            >
              {isAnalyzing ? (
          ...
          <div className="bg-surface/50 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden p-8 shadow-2xl">
            <div className="animate-pulse flex flex-col items-center justify-center py-20">
              <div className="relative w-24 h-24 mb-8">
                ...
                <Network className="w-8 h-8 text-fuchsia-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
              </div>
              ...
              <div className="w-full max-w-md mt-12 space-y-3">
                <div className="h-2 bg-white/10 rounded overflow-hidden">
                  <div className="h-full bg-fuchsia-500/50 w-1/3 animate-pulse"></div>
                </div>
                <div className="h-2 bg-white/10 rounded overflow-hidden">
                  <div className="h-full bg-fuchsia-500/30 w-2/3 animate-pulse delay-75"></div>
                </div>
                <div className="h-2 bg-white/10 rounded overflow-hidden">
                  <div className="h-full bg-fuchsia-500/40 w-1/2 animate-pulse delay-150"></div>
                </div>
              </div>
            </div>
          </div>
